...
namespace spjalla::events {
	...
	struct notification_event: public pingpong::event {
		...
		notification_event(ui::window *window_, std::shared_ptr<lines::line> line_, notification_type type_):
	...
	struct window_notification_event: public notification_event {
		...
		window_notification_event(ui::window *window_, std::shared_ptr<lines::line> line_, notification_type new_type_,
